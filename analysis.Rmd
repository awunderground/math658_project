...
By Wright (12.14), $V(\hat{p}_{str}) = \sum_{h = 1}^H (\frac{N_h}{N})^2 V(\hat{p}_h) = \sum_{h = 1}^H (\frac{N_h}{N})^2 \frac{N_h - n_h}{N_h - 1} \frac{\hat{p}(1 - \hat{p})}{n_h}$

$V(\hat{p}_h) = (\frac{N_h}{N})^2 \frac{N_h - n_h}{N_h - 1} \frac{\hat{p}(1 - \hat{p})}{n_h}$

$V(\hat{p}_h) = \frac{N^2_h}{N^2} \frac{N_h}{N_h - 1} \frac{\hat{p}(1 - \hat{p})}{n_h} - \frac{N^2_h}{N^2} \frac{n_h}{N_h - 1}\frac{\hat{p}(1 - \hat{p})}{n_h}$

$V(\hat{p}_h) = \frac{N^2_h}{N^2} \frac{N_h}{N_h - 1} \frac{\hat{p}(1 - \hat{p})}{n_h} - \frac{N^2_h}{N^2} \frac{n_h}{N_h - 1}\frac{\hat{p}(1 - \hat{p})}{n_h}$

$V(\hat{p}_h) = \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2 (N_h - 1)} \frac{1}{n_h} - \frac{N^2_h \hat{p}(1 - \hat{p})}{N^2 (N_h - 1)}$

$V(\hat{p}_h) = \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2 (N_h - 1)} (1 - \frac{1}{1 \cdot 2} - \frac{1}{2 \cdot 3} - \cdot\cdot\cdot  - \frac{1}{n_h(n_h - 1)}) - \frac{N^2_h \hat{p}(1 - \hat{p})}{N^2 (N_h - 1)}$

$V(\hat{p}_h) = \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1)} - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot 1 \cdot 2} - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot 2 \cdot 3} - \cdot\cdot\cdot - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot n_h(n_h - 1)} - \frac{N^2_h \hat{p}(1 - \hat{p})}{N^2 (N_h - 1)}$

$V(\hat{p}_h) = \frac{(N^3_h - N^2_h) \hat{p}(1 - \hat{p})}{N^2(N_h - 1)} - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot 1 \cdot 2} - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot 2 \cdot 3} - \cdot\cdot\cdot - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot n_h(n_h - 1)}$

$V(\hat{p}_h) = \frac{N^2_h (N_h - 1) \hat{p}(1 - \hat{p})}{N^2(N_h - 1)} - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot 1 \cdot 2} - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot 2 \cdot 3} - \cdot\cdot\cdot - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot n_h(n_h - 1)}$

\hfill

Decomposition of $V(\hat{p}_{str})$

$V(\hat{p}_{str}) = \sum_{h = 1}^H \frac{N^2_h (N_h - 1) \hat{p}(1 - \hat{p})}{N^2(N_h - 1)}$


$- \frac{N^3_1 \hat{p}(1 - \hat{p})}{N^2(N_1 - 1) \cdot 1 \cdot 2} - \frac{N^3_1 \hat{p}(1 - \hat{p})}{N^2(N_1 - 1) \cdot 2 \cdot 3} - ... - \frac{N^3_1 \hat{p}(1 - \hat{p})}{N^2(N_1 - 1) n_h(n_h - 1)}$

...

$- \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot 1 \cdot 2} - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) \cdot 2 \cdot 3} - ... - \frac{N^3_h \hat{p}(1 - \hat{p})}{N^2(N_h - 1) n_h (n_h - 1)}$

...

$- \frac{N^3_H \hat{p}(1 - \hat{p})}{N^2(N_H - 1) \cdot 1 \cdot 2} - \frac{N^3_H \hat{p}(1 - \hat{p})}{N^2(N_H - 1) \cdot 3 \cdot 3} - ... - \frac{N^3_H \hat{p}(1 - \hat{p})}{N^2(N_H - 1) n_h (n_h - 1)}$
